...
list_data = ["Sensor : Tempreture , Tempreture : 13.09 , Humidity : 2.12" , "Sensor : GPS , Altitude : 234 , Longitude : 12"]
list_data.append("Sensor : Motion , Velocity : 23 , acceleration : 12.3 , rotation : 38")
