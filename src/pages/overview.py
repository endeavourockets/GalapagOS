    ...
    html.Div([
       html.Div([
            html.Div([
                ...
                html.Div([
                    html.Img(src='assets/images/rocket/circle.svg', height='300', style=svg_style),
                    html.Img(src='assets/images/rocket/rocket_black.svg', height='300', style=svg_style_circle, id='rocket_xz'),
       ...
       html.Div([
            html.Div([
                ...
                html.Div([
                    html.Img(src='assets/images/rocket/circle.svg', height='300', style=svg_style),
                    html.Img(src='assets/images/rocket/rocket_black.svg', height='300', style=svg_style_circle, id='rocket_yz'),
                    html.Div('', style={'height':'300px'}),
                ],
                className='card-body'),
       ...
       html.Div([
            html.Div([
                ...
                className='card-header'),
                html.Div([
                    dcc.Graph(id='altitude-graph',figure=go.Figure(data=[go.Scatter(x=[0], y=[0])]))
                ],
                className='card-body'),
